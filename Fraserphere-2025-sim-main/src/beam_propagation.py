...
# Use absolute path for results (adjust to your repo root)
base_dir = r"C:\Users\kfras\Fraserphere-2025-sim\Fraserphere-2025-sim-main"
...
plt.legend()
plt.savefig(os.path.join(base_dir, "results", "plots", "spot_size.png"))
# ... (rest unchanged)
